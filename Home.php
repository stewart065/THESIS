...
<head>
    ...
    <title>Home page  | Trans-Master APARORS</title>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class=" me-auto mb-2 mb-lg-0">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="searchText" id="searchme" placeholder="Search for..." aria-label="Search for..." aria-describedby="btnNavbarSearch" required />
...
<div class="container-fluid mt-3">
    ...
    <?php
            ...
            ?> 
        <a href="Home-view-product.php?pid=<?php echo $prodid; ?>">
          <div class="col">
