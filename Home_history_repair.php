...
<head>
  ...
  <title>Repair History | Trans-Master APARORS</title>
    ...
    <div class="container py-5">
      <div class="row d-flex justify-content-center my-4">
        ...
        $sql = "SELECT  CONCAT(firstname, lastname) AS name ,id, reserve_date, reserve_time, vehicle_brand, year_model, vehicle_type,service_type,repair_reservation.status
                 from repair_reservation INNER JOIN users ON users.customer_id = repair_reservation.cus_id  where cus_id = '$cusid' && repair_reservation.status = 'Finished'";
